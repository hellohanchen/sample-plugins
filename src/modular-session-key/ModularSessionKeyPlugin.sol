...
contract ModularSessionKeyPlugin is IModularSessionKeyPlugin, BasePlugin {
        ...
        returns (uint256)
    {
        ...
        revert NotImplemented(bytes4(userOp.callData), functionId);
    }
        ...
        override
    {
        ...
        revert NotImplemented(bytes4(data), functionId);
    }
